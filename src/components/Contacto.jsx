...
import { Mail, Phone, MapPin, Facebook, Instagram, Twitter, Linkedin, Github } from "lucide-react";
import { z } from "zod";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="p-6 space-y-8">
                ...
                >
                  ...
                  <div>
                    ...
                    <a href="mailto:contacto@innovatechmex.com" className="text-[#00ADBF] hover:underline">contacto@innovatechmex.com</a>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <a href="tel:+5222142909850" className="text-[#00ADBF] hover:underline">+52 221 429 0985</a>
                  </div>
                </motion.div>
                ...
                <div className="pt-6 border-t border-slate-100">
                  <h4 className="text-lg font-semibold text-[#000052] mb-4">Síguenos</h4>
          ...
          >
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-[#000052] mb-6">Envíanos un mensaje</h3>
