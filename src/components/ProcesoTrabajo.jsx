  ...
  return (
    <motion.div
      ...
      whileHover={{
        ...
        scale: 1.02,
        boxShadow:
          "0 25px 30px -5px rgba(0, 0, 0, 0.15), 0 10px 15px -5px rgba(0, 0, 0, 0.08)",
      }}
    >
      ...
      <motion.div
        ...
        style={{
          background: `radial-gradient(circle, ${gradientStyle.from} 0%, transparent 70%)`,
        }}
        animate={{
          scale: [1, 1.2, 1],
        }}
      ...
      <div className="p-7 flex flex-col h-full bg-white/60 backdrop-blur-sm relative z-10">
        <div className="flex items-center mb-5">
          <motion.div
            ...
            style={{
              background: `linear-gradient(135deg, ${gradientStyle.from}, ${gradientStyle.to})`,
            }}
            whileHover={{ scale: 1.1, rotate: 10 }}
            transition={{ duration: 0.4 }}
          >
            <span className="mr-1">{gradientStyle.icon}</span>
            {numero}
          </motion.div>
          <h3 className="text-xl font-bold bg-gradient-to-r from-[#000052] to-[#C5299B] bg-clip-text text-transparent">
            {titulo}
          </h3>
        </div>
        <motion.p
  ...
  const pasos = [
    {
      ...
      descripcion:
        "Se analiza el proyecto en su totalidad, considerando sus objetivos, alcances, recursos necesarios y expectativas del cliente para definir una ruta de trabajo óptima.",
      delay: 0.1,
      fase: "Inicial",
      icon: "📋",
      tiempo: "1-2 dias",
    },
    {
      ...
      descripcion:
        "Organizamos el proceso de producción con tiempos, materiales y metodologías específicas. Realizamos simulaciones digitales para anticipar problemas y optimizar resultados antes de comenzar.",
      delay: 0.2,
      fase: "Inicial",
      icon: "🔄",
      tiempo: "2-3 dias",
    },
    {
      ...
      descripcion:
        "Elaboramos un presupuesto transparente con los costos estimados de cada fase del proyecto, materiales de alta calidad y tiempos de ejecución garantizados.",
      delay: 0.3,
      fase: "Planificación",
      icon: "💰",
      tiempo: "1-2 dias",
    },
    {
      ...
      descripcion:
        "Ejecutamos la fase de construcción o ensamblaje de componentes siguiendo especificaciones técnicas y estándares internacionales de calidad para asegurar un funcionamiento óptimo.",
      delay: 0.4,
      fase: "Ejecución",
      icon: "🔨",
      tiempo: "4-8 dias",
    },
    {
      ...
      descripcion:
        "Realizamos verificaciones técnicas rigurosas y pruebas de calidad dentro de nuestra empresa para asegurar que el producto cumple o supera los estándares y especificaciones requeridas.",
      delay: 0.5,
      fase: "Control",
      icon: "⚙️",
      tiempo: "1-2 dias",
    },
    {
      ...
      descripcion:
        "Presentamos el producto final al cliente para su revisión. Recibimos sugerencias y realizamos ajustes finales para garantizar que cumple o supera todas las expectativas iniciales.",
      delay: 0.6,
      fase: "Validación",
      icon: "👁️",
      tiempo: "1-2 dias",
    },
    {
      ...
      descripcion:
        "Implementamos un ciclo de retroalimentación donde integramos los comentarios del cliente y realizamos ajustes iterativos para perfeccionar el producto. Este proceso asegura que la solución final esté completamente alineada con la visión del cliente.",
      delay: 0.65,
      fase: "Iteración",
      icon: "🔄",
      tiempo: "1-2 dias",
    },
    {
      ...
      descripcion:
        "Completamos el proceso con el envío o instalación profesional del producto, asegurando que el cliente lo recibe en óptimas condiciones, con capacitación de uso y toda la documentación técnica necesaria.",
      delay: 0.7,
      fase: "Final",
      icon: "🚀",
      tiempo: "1-2 dias",
    ...
    <section id="proceso" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-5xl mx-auto mb-20">
          ...
          >
            En InnovaTech contamos con una metodología de trabajo probada que
            garantiza el éxito de nuestros proyectos. Cada fase está
            cuidadosamente diseñada para asegurar que entregamos soluciones de
            alta calidad que superan las expectativas de nuestros clientes.
          </motion.p>
        </div>{" "}
        {/* Timeline del proceso (visible en pantallas grandes) */}
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <h3 className="text-xl font-bold text-[#000052] mb-3">
                      {paso.titulo}
                    </h3>
        ...
        {/* Proceso de trabajo en diseño de tarjetas (visible en todos los tamaños) */}
        ...
        <div className="hidden xl:block my-20 relative max-w-6xl mx-auto bg-white/30 backdrop-blur-sm p-14 rounded-xl border border-white/20 shadow-lg">
          ...
          <div className="flex justify-between relative mx-5 gap-10">
            {pasos.map((paso, index) => (
              <div key={index} className="flex flex-col items-center relative">
                {/* Nodos del proceso */}
                <motion.div
                  className="w-16 h-16 rounded-full bg-white shadow-lg border-3 z-10 flex items-center justify-center font-bold cursor-pointer -mt-5"
                  style={{
                    borderColor:
                      paso.numero % 3 === 1
                        ? "#000052"
          ...
          <div className="max-w-5xl mx-auto bg-gradient-to-r from-[#000052] to-[#C5299B] p-16 rounded-3xl shadow-2xl text-white relative z-10">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-10 relative z-10">
              <div className="mb-6 md:mb-0">
                ...
                >
                  ¿Listo para transformar tus ideas
                  <br className="hidden md:block" /> en soluciones innovadoras?
                </motion.h3>
