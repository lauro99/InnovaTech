...
export default function Home() {
  ...
  // Cambiar el fondo a blanco y actualizar los colores secundarios
  return (
    <div
      className={`${geistSans.className} ${geistMono.className} bg-white text-[#000052] min-h-screen flex flex-col`}
    >
      {/* HERO */}
      <section className="flex flex-col items-center justify-center py-20 gap-4 text-center bg-gradient-to-b from-[#00CBFA] to-transparent">
